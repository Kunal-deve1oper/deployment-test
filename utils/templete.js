...
const getTemplate = (name)=>{
    ...
    <tbody style="margin-top: 15px;">
      <tr class="">
    <td class="">
    <img alt="robot picture" class="" height="155" src="https://cdn.logo.com/hotlink-ok/logo-social.png" width="200">
    </td>
    </tr>
    <tr class=""><td class="headline">Welcome to MyShop!</td></tr>
    <tr>
    <td>
    <center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
    <td class="" style="color:#444; font-weight: 400;"><br><br>
     A Revolutionary AI website better than chatGPT. <br><br>
      You have successfully been registered to use MyShop as <em>${name}</em><br>
